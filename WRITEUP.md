...
The carry signal enters when the 8-hour funding rate exceeds 0.01%. Position sizing is inverse 30-day realized volatility, normalized across assets. The cost model applies a fixed half-spread to both legs per unit of turnover, defaulting to 5 bps per side. P&L decomposes into funding income, cost drag, and basis mark-to-market each period.
